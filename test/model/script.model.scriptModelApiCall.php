...
if($argv[1] == $array[0])
{
    $url = "http://localhost:82/git/api_final/?model=profil&field=EMAIL&value=arthur.rubiralta@ecole-89.com";
...
{
    $url = "http://localhost:82/git/api_final/?model=profil";
...
{
    $url = "http://localhost:82/git/api_final/?model=project";
...
{
    $url = "http://localhost:82/git/api_final/?model=project&ID=8";
